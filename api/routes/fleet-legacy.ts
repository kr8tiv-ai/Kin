/**
 * Fleet Routes — LEGACY STUB (not registered)
 *
 * This file is the original in-memory fleet monitor that was replaced by
 * fleet/routes.ts (backed by FleetDb + ContainerManager) in M004/S01/T03.
 * Kept for reference only — NOT imported or mounted by api/server.ts.
 */
